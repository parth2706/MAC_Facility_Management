...
<input name="errMsg"  value="<c:out value='${errorMsgs}'/>" type="text"  style ="background-color: white; color: red; border: none; width:800px" disabled="disabled">
 ...
 <form action="/mac/SystemUserController?action=ViewSpecificUser" method="post">          
       <table border="1" class="myTable"> 
 		...
 		<c:forEach items="${USERS}" var="item" varStatus="status">
            ...
            <td> <a href="/mac/SystemUserController?action=ViewSpecificUser&id=${item.username}">View</a></td>
			</tr>
		</c:forEach>
 </table>
 </form>
