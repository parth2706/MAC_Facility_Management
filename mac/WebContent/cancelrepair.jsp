 ...
 <form action="/mac/MarController?action=listReservations" method="post">          
       <table border="1" class="myTable"> 
 		...
 		<c:forEach items="${RESERVATION}" var="item" varStatus="status">
			<tr class="myTableRow">
			<td class="myTableCell" style="width: 20px; text-align: center"><input type="radio" id="marNumberToCancel" name="marNumberToCancel" value="${item.marnumber}"></td> 	
...
<input name="ListSelectedReservation" type="submit" value="Cancel Reservation">
 </form>
 <a href="repairerhomepage.jsp">Back to Homepage</a>
</body>
</html>