  ...
  <div class="content">  
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="/mac/MarController?action=cancelReservations"  target="_top"><span>Cancel Reservation</span></a></li>  
          <li><a href="/mac/MarController?action=modifyReservation"  target="_top"><span>Modify Reservation</span></a></li>
